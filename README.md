...
## Conclusion - LogP results

The RDKit logP values follow the same trend as the experimental logP values, but they are not the same. RDKit can tell which molecules are more or less lipophilic, but it cannot predict the exact experimental values.